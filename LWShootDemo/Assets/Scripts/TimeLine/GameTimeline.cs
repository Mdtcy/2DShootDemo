...
public class TimelineObj{
    ...
    public TimelineObj(TimelineModel model, GameObject caster, object param){
        ...
        //     if (character){
        //         this.values.Add("faceDegree", character.faceDegree);
        //         this.values.Add("moveDegree", character.moveDegree);
        //     }
        //     this._timeScale = character.actionSpeed;
        // }
        this.param = param;
    }
...
public struct TimelineNode{
    ...
    public TimelineNode(float time, string doEve, params object[] eveArgs){
        ...
        this.doEvent = DesignerScripts.TimelineFunc.functions[doEve];
