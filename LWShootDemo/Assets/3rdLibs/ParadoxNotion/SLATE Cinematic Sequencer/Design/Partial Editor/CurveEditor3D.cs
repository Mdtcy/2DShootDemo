                ...
                for ( var k = 0; k < curveX.length; k++ ) {
                    ...
                    if ( kIndex == k ) {
                        if ( Tools.current == Tool.Move ) {
                            ...
                            var fmh_195_68_638327397331946690 = Quaternion.identity; newValue = Handles.FreeMoveHandle(pos, pointSize, Vector3.zero, Handles.RectangleHandleCap);
                        }
                    }
                    ...
                    if ( haveSameTangents && tangentMode == TangentMode.Editable ) {
                        ...
                        if ( kIndex == k ) {
                            ...
                            if ( k != 0 ) {
                                ...
                                var fmh_223_84_638327397331989637 = Quaternion.identity; var newInHandle = Handles.FreeMoveHandle(inHandle, handleSize, Vector3.zero, Handles.CircleHandleCap);
                            ...
                            if ( k < curveX.length - 1 ) {
                                ...
                                var fmh_249_86_638327397332002239 = Quaternion.identity; var newOutHandle = Handles.FreeMoveHandle(outHandle, handleSize, Vector3.zero, Handles.CircleHandleCap);
