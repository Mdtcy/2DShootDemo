...
namespace Slate
{
    ...
    public class BezierPathEditor : Editor
    {
        ...
        void DrawPointSceneGUI(BezierPoint point, int index) {
            ...
            var fmh_82_52_638327397335405874 = Quaternion.identity; Handles.FreeMoveHandle(point.position, pointGUISize, Vector3.zero, Handles.RectangleHandleCap);
            ...
            var fmh_90_76_638327397335438106 = Quaternion.identity; var newGlobal1 = Handles.FreeMoveHandle(point.handle1Position, HandleUtility.GetHandleSize(point.handle1Position) * 0.075f, Vector3.zero, Handles.CircleHandleCap);
            ...
            var fmh_98_76_638327397335445795 = Quaternion.identity; var newGlobal2 = Handles.FreeMoveHandle(point.handle2Position, HandleUtility.GetHandleSize(point.handle2Position) * 0.075f, Vector3.zero, Handles.CircleHandleCap);
