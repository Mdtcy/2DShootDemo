...
namespace InteliMapPro
{
    public class InteliMapBuilder : MonoBehaviour
    {
        ...
        public class TrainingAdvanced
        {
            ...
            [Tooltip("The priority to use for the training threads. Higher values may increase training speed.")]
        ...
        public void Build()
        {
            ...
            else
            {
                ...
                neighborhoodRadius = generatorData.weights.GetNeighborhoodRadius();
